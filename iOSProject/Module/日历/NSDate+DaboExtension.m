...
- (NSUInteger)weeklyOrdinality
{
    ...
    NSLog(@"%lu",(unsigned long)firstDayOfMonthDate.weekday);
...
//获取当前NSDate的下一个月第一天
- (NSDate *)firstDayInTheFollowingMonth
{
    NSDateComponents *dateComponents = [[NSDateComponents alloc] init];
    dateComponents.month = 1;
    return [self.calendar dateByAddingComponents:dateComponents toDate:[self startOfCurrentMonth:self] options:0];
}

- (NSDate *)startOfCurrentMonth:(NSDate *)date{
